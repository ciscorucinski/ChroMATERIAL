...
|||
| **Languages** | <kbd>Java</kbd> <kbd>Android</kbd> <kbd>Kotlin</kbd> <kbd>Groovy</kbd> <kbd>XML</kbd> <kbd>JSON</kbd> <kbd>HTML</kbd> <kbd>C / C++</kbd> <br><sub><sup>**Pull Requests** are welcome.</sup></sub> |
|||
| **Others**    | <kbd>Android Manifest</kbd> <kbd>Android Resources</kbd> <kbd>Gradle</kbd> <kbd>Logcat</kbd> <kbd>Proguard Files</kbd> <kbd>Property Files</kbd> <kbd>Version Control</kbd> <kbd>Debugger</kbd> <kbd>Diff</kbd> <kbd>Ignore Files *</kbd> <kbd>Markdown *</kbd> <kbd>RegExp</kbd> <kbd>YAML</kbd> <kbd>XSLT</kbd> <kbd>XPATH</kbd> <br><sub><sup>**Pull Requests** are welcome.</sup></sub> |
